		...
		if (result != null) {
			...
			case 20:
				...
				if (data != null) {
					...
					View view = LayoutInflater.from(context).inflate(R.layout.fragment_detailscreen, null);

					final DetailScreenDialog dlg = new DetailScreenDialog(context, view, HomeActivity.getAppCenter(), animal);
